...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/project/project.srcs/./C:/Users/vele/Desktop/Workspace/Project_FPGA/fpga-tutorial-6-RGB_PWM_Control/ip/vio_user_leds/vio_user_leds.xci"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/src/common/clock_enable_generator.v"]"\
 "[file normalize "$origin_dir/src/led/io_user_leds.v"]"\
 "[file normalize "$origin_dir/src/led/pwm_controller.v"]"\
 "[file normalize "$origin_dir/src/led/rainbow_controller.v"]"\
 "[file normalize "$origin_dir/src/top.v"]"\
 "[file normalize "$origin_dir/ip/ila_user_leds/ila_user_leds.xci"]"\
...
set files [list \
 [file normalize "${origin_dir}/ip/vio_user_leds/vio_user_leds.xci"]\
]
...
# Set 'sources_1' fileset file properties for local files
set file "vio_user_leds/vio_user_leds.xci"
...
# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/ip/ila_user_leds/ila_user_leds.xci"
...
set_property -name "auto_incremental_checkpoint.directory" -value "C:/Users/vele/Desktop/Project_FPGA/5_zikki_test/project/project.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "needs_refresh" -value "1" -objects $obj
set_property -name "part" -value "xc7a35ticsg324-1L" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "C:/Users/vele/Desktop/Project_FPGA/5_zikki_test/project/project.srcs/utils_1/imports/impl_1" -objects $obj
